...
def generate_launch_description():
    ...
    # IP por defecto para el sensor de PERFIL
    hostname_launch_arg = DeclareLaunchArgument('hostname', default_value='192.168.0.2')
    udp_receiver_ip_launch_arg = DeclareLaunchArgument('udp_receiver_ip', default_value='0.0.0.0')

    sick_scan_node = Node(
        package='sick_scan_xd',
        executable='sick_generic_caller',
        name='sick_scan_xd_perfil', # Nombre único
        output='screen',
        parameters=[
