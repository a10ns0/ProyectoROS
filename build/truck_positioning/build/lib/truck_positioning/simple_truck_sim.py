...
class TruckSimulator(Node):
    def __init__(self):
        ...
        # Publicadores de Sensores Falsos (Para engañar a tu algoritmo)
        self.pub_scan1 = self.create_publisher(LaserScan, '/sick_entry/scan', 10)
        self.pub_scan2 = self.create_publisher(LaserScan, '/sick_end/scan', 10)
